  ...
  return (
    ...
    >
      <div className="flex flex-col justify-evenly text-center h-100 w-3/4 lg:w-1/2 p-3 mt-7 rounded-2xl shadow-xl bg-acc2">
        ...
        <p className="text-xs sm:text-xs md:text-sm lg:text-base text-acc4">
          I am a Weber State University Graduate, with an Associate's degree in
          general sciences. I have recently discovered a growing passion for web
          development and have been seeking to improve my abilities.
        </p>
        <p className="text-xs sm:text-xs md:text-sm lg:text-base text-acc4">
